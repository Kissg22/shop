...
if(!isset($_SESSION['user'])){
    alert('warning','Regisztrálj vagy jelenkezz be a folytatáshoz.');
          ...
          <section class="col-lg-8">
            ...
            <div class="d-sm-flex justify-content-between align-items-center bg-secondary p-4 rounded-3 mb-grid-gutter">
              <div class="d-flex align-items-center">
                <div class="img-thumbnail rounded-circle position-relative flex-shrink-0"><span class="badge bg-warning position-absolute end-0 mt-n2" data-bs-toggle="tooltip" title="Reward points"><?=$u["id"] ?></span><img class="rounded-circle" src="user.png" width="90" alt="User"></div>
                <div class="ps-3">
